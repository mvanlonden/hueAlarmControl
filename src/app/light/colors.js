...
window.colors = function () {
    ...
    return {
        ...
        CIEToRGB : function (x, y, hue) {
            console.log(x, y, hue);
            var r = 3.240479*((x*hue)/y) + -1.537150*hue + -0.498535*(((1-x-y)*hue)/y)
            var g = -0.969256*((x*hue)/y) + 1.875992*hue + 0.041556*(((1-x-y)*hue)/y)
            var b = 0.055648*((x*hue)/y) + -0.204043*hue + 1.057311*(((1-x-y)*hue)/y)
            return {r: r, g: g, b: b};
        },
